...
if __name__ == '__main__':
    ...
    np.savetxt(f'sf_gp_data/xray/{id}_{n_samples}_times', x_ray_tao_plot)
    np.savetxt(f'sf_gp_data/xray/mean_structure_function_{n_samples}_{id}', x_ray_mean_structure_function)
    np.savetxt(f'sf_gp_data/xray/std_structure_function_{n_samples}_{id}', x_ray_std_structure_function)
    ...
    np.savetxt(f'sf_gp_data/uv/std_structure_function_{n_samples}_{id}', uv_std_structure_function)
