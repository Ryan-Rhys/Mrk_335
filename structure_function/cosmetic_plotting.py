...
if __name__ == '__main__':
    ...
    if kernel == 'RQ':
        broken_power_law_model = BrokenPowerLaw1D(alpha_1=0, alpha_2=0, x_break=110)
    else:
        broken_power_law_model = BrokenPowerLaw1D(alpha_1=-1, alpha_2=0, x_break=110)
    ...
    plm = fitter_plm(broken_power_law_model, power_law_tao_vals, power_law_sf_vals, weights=1/uv_gp_std_structure_function,
                      maxiter=5000)

    plm_index1 = plm.alpha_1.value
    plm_index2 = plm.alpha_2.value
    ...
    plt.savefig(f'cosmetic_figures/gp_structure_function_uv_{tag}_on_same_axis_'
                f'alpha_is_{str(100*plm_index1)}_alpha2_is_{str(100*plm_index2)}_x_break_is_{str(100*x_break)}.png')
    plt.close()
